# -*- coding: utf-8 -*-
"""Copy of MIC Workshop 5: Reinforcement Learning.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1o4dJTmhSp04hWa2fCZ5e83pA_ONl6l3c

# MIC Workshop 5: Reinforcement Learning
...
![alt text](https://miro.medium.com/max/768/1*pEcq5MyHSSO6bgIiWE3GOQ.png)
...
**Matplotlib** :matplotlib is a plotting library for the Python programming language and its numerical mathematics 
...
#Make and unwrap gym environment for the cartpole problem

env = gym.make('CartPole-v0').unwrapped

# if you want to use on gpu
...
#getting cart location in unwrapped environment
...
**Gamma** : A scalar value between 0 and 1 which determines the present value of future rewards. If the discount factor is 0, the agent is concerned with maximizing immediate rewards. As the discount factor approaches 1, the agent takes more future rewards into account.

**Epsilon** : We specify an exploration rate “epsilon,"". This is the rate of steps that we’ll do randomly. In the beginning, this rate must be at its highest value, because we don’t know anything about the values in Q-table. This means we need to do a lot of exploration, by randomly choosing our actions.
...
**Target Update** : No of episodes after which to update weights of target network
"""
...
By definition we set $V(s) = 0$ if $s$ is a terminal
state. We also use a target network to compute $V(s_{t+1})$ for
added stability. 
The target network has its weights kept frozen most of
...
Set number of episodes that would be required to get a model which works.
"""
...
imageio.mimwrite('cartpole_rl.mp4', frames , fps = 30)
...
"""#To see how your agent performs post training, run the cell below."""

from google.colab import files
files.download("cartpole_rl.mp4")
